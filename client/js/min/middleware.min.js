...
var url="http://192.168.43.49:8080/hello",socket=new SockJS(url);stompClient=Stomp.over(socket),stompClient.connect({},function(){stompClient.subscribe("/player/songAdded",function(n){return console.log(n),JSON.parse(n.body).content}),stompClient.subscribe("/player/songRemoved",function(n){return console.log(n),JSON.parse(n.body).content}),stompClient.subscribe("/player/clientDisconnected",function(n){return console.log(n),JSON.parse(n.body).content}),stompClient.subscribe("/player/uploadSong",function(n){return console.log(n),JSON.parse(n.body).content}),stompClient.subscribe("/player/songPlaying",function(n){return console.log(n),JSON.parse(n.body).content}),stompClient.subscribe("/player/songPaused",function(n){return console.log(n),JSON.parse(n.body).content}),stompClient.subscribe("/player/songStopped",function(n){return console.log(n),JSON.parse(n.body).content}),stompClient.send("/app/addSong",{},JSON.stringify({name:"name"}))}),$.subscribe("addedSong",function(n,e){var o=new Song(e.file);stompClient.send("/app/addSong",{},JSON.stringify(o.toJSON()))}),$.subscribe("removedSong",function(){stompClient.send("/app/removeSong",{},JSON.stringify({id:song.id}))}),$.subscribe("playCurrent",function(){stompClient.send("/app/playCurrent",{},JSON.stringify({}))}),$.subscribe("pauseCurrent",function(){stompClient.send("/app/pauseCurrent",{},JSON.stringify({}))}),$.subscribe("stopCurrent",function(){stompClient.send("/app/stopCurrent",{},JSON.stringify({}))}),$.subscribe("previousSong",function(){stompClient.send("/app/removeSong",{},JSON.stringify({}))}),$.subscribe("nextSong",function(){stompClient.send("/app/nextSong",{},JSON.stringify({}))}),$.subscribe("reorderPlaylist",function(){stompClient.send("/app/reorderPlaylist",{},JSON.stringify({}))});